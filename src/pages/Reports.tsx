...
const Reports = () => {
  ...
  const mockData: ReportData = {
    ...
    propertyDistribution: [
      { property: 'Sunset Apartments', count: 89, percentage: 14.2 },
      { property: 'Riverside Condos', count: 76, percentage: 12.1 },
      { property: 'Garden View Townhouse', count: 65, percentage: 10.4 },
      { property: 'Metro Lofts', count: 54, percentage: 8.6 },
      { property: 'Downtown Plaza', count: 43, percentage: 6.9 },
      { property: 'Oak Street Complex', count: 38, percentage: 6.1 },
      { property: 'Pine Ridge Estates', count: 35, percentage: 5.6 },
      { property: 'Maple Heights', count: 32, percentage: 5.1 },
      { property: 'Willow Creek Manor', count: 29, percentage: 4.6 },
      { property: 'Cedar Point Homes', count: 26, percentage: 4.2 },
      { property: 'Elmwood Residences', count: 24, percentage: 3.8 },
      { property: 'Parkview Towers', count: 21, percentage: 3.4 },
      { property: 'Hillside Villas', count: 19, percentage: 3.0 },
      { property: 'Brookstone Commons', count: 17, percentage: 2.7 },
      { property: 'Lakefront Suites', count: 15, percentage: 2.4 },
      { property: 'Magnolia Court', count: 13, percentage: 2.1 },
      { property: 'Rosewood Gardens', count: 11, percentage: 1.8 },
      { property: 'Heritage Square', count: 9, percentage: 1.4 },
      { property: 'Ashford Place', count: 8, percentage: 1.3 },
    ],
  };
