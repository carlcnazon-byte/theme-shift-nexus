...
export const VendorCard: React.FC<VendorCardProps> = ({ vendor }) => {
  ...
  return (
    <Card className="bg-card border-border hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
      <CardContent className="p-6 flex-1 flex flex-col">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-lg font-semibold text-foreground truncate">{vendor.company_name}</h3>
        ...
        <div className="space-y-2 mb-4 min-h-[80px]">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium text-foreground">{vendor.average_response_time || 30}min</span>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span className="text-muted-foreground">Hourly Rate</span>
            <span className="font-medium text-foreground">${vendor.hourly_rate || 75}</span>
          </div>
        </div>
        ...
        <div className="space-y-2 mb-4 pt-3 border-t border-border">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-foreground truncate">{vendor.phone_number}</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
